...
В данном профиле включены: учебные проекты, решения к тестовым заданиям, пет-утилиты и экспериментальные автотесты
...
- Postman + Swagger (API, JSON, XML, request/response)
- DevTools (Network, DOM, Cookies)
- Charles Proxy
- Android Studio
- Terminals: Bash, SygWin, ADB, Ubuntu-terminal
- Jira
- Git
- GitHub
- VSCode
